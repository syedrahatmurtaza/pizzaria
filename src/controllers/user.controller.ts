import { Body, Controller, Example, Get, Path, Post, Put, Request, Response, Route, Security, SuccessResponse, Tags } from "tsoa";
...
import { IUserGetUserRequest, IUserRegisterRequest, IUserUpdateRequest } from "../types/requests/user.request";
import { IUserGetAllResposne, IUserGetUserNotFoundReponse, IUserGetUserResponse, IUserRegisterErrorResponse, IUserRegisterResponse, IUserUpdateResposne } from "../types/responses/user.response";
...
export class UserController extends Controller {
    ...
    @Response('403', 'Forbidden Request', 'If you don\'t pass any accessToken It will return a 403 Forbidden Access')
    async registerUser(
    ...
    async getUser(
        ...
        // if (user == null) {
        //     return <IUserGetUserNotFoundReponse>{
        //         errorCode: 404,
        //         message: 'User not found'
        //     }
        // } else if (<InvalidObjectIdError>user) {
        //     return <InvalidObjectIdError>user
        // }
    ...
    @Put('/updateUser')
    async updateUser(@Body() requestBody: IUserUpdateRequest): Promise<IUserUpdateResposne> {
